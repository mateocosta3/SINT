...
public class FrontEnd {
	...
	public static void sendHTML01(HttpServletResponse resaux) 
	{
	    try {
	    	...
	    	out.println("<link rel='stylesheet' type='text/css' href='p2/p2.css'>"); //Enlazamos el HTML con el CSS
	    	out.println("</head>");
	    	out.println("<body>");
	    	...
	    	out.println("<ul>");
	    	out.println("<li><a href='?pphase=02&p=P2Sint34pw'>Ver los ficheros erróneos</a>"); //Creamos un enlace a la pphase=02
	    	out.println("<li><a href='?pphase=11&p=P2Sint34pw'>Consulta 1: canciones pop de un Album de un Country</a>"); //Creamos un enlace a la pphase=11
	    	out.println("</ul>");

	    	out.println("<form>");
	    	out.println("<input type='hidden' name='p' value='P2Sint34pw'>");
	...
	public static void sendHTML02(HttpServletResponse resaux,ArrayList<String> FES,ArrayList<String> FEF) 
	{
	    ...
	    out.println("</ul>");
	    out.println("<form>");
	    out.println("<a href='?pphase=01&p=P2Sint34pw'>"); //Creamos un enlace a la pphase=01
	...
	public static void sendHTML11(HttpServletResponse resaux,ArrayList<String> paises) 
	{
	    ...
	    for (int i = 0; i < paises.size(); i++) { //Recorremos la lista de países recibida como parámetro
		    ...
		    out.println("<li><a href='?pphase=12&p=P2Sint34pw&pcountry="+pais+"'>"+pais+"</a>"); //Creamos un enlace a la pphase=12 con el pcountry del país seleccionado
	    }
	...
	public static void sendHTML12(HttpServletResponse resaux,String pais,ArrayList<Album> albums) 
	{
	    ...
	    for (int i = 0; i < albums.size(); i++) { //Recorremos la lista de albums recibida como parámetro
	    	    ...
	    	    out.println("<li><a href='?pphase=13&p=P2Sint34pw&pcountry="+pais+"&paid="+album.getAid()+"'>Álbum = '"+album.getName()+"'</a>");
	    ...
	    out.println("<input type='button' name='Inicio' value='Inicio'>"); //Asignamos dicho enlace a un botón
	    out.println("</a>");
	    out.println("<a href='?pphase=11&p=P2Sint34pw'>"); //Creamos un enlace a la pphase=11
	    out.println("<input type='button' name='Atrás' value='Atrás'>"); //Asignamos dicho enlace a un botón
	    out.println("</a>");
	    out.println("</form>");
	...
	public static void sendHTML13(HttpServletResponse resaux,String pais,String idalb,ArrayList<Song> songs) 
	{
	    ...
	    out.println("<a href='?pphase=12&p=P2Sint34pw&pcountry="+pais+"'>"); //Creamos un enlace a la pphase=12 con el pcountry recibido como parámetro
	    out.println("<input type='button' name='Atrás' value='Atrás'>"); //Asignamos dicho enlace a un botón
	    out.println("</a>");
	    out.println("</form>");
